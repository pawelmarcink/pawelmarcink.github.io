...
var opt="up";
           ...
           if(opt=="left"){
           opt="up";
           $("#sidebar").slideUp('slow', function () {$("#sidebar").hide()});
           $("#sitenav").fadeIn('slow', function () {$("#sitenav").show()});
           }
           else{
           opt="left";
           $("#sitenav").fadeOut('slow', function() { $("#sitenav").hide() });
           $("#sidebar").fadeIn('slow', function () {$("#sidebar").show()});
           }
